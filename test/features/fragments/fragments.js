...
var fragments = function (text)
{
    ...
    var mapping = {
        goodNewsText: element.bind(null, by.id('myButton1')),
        abcLabel: element.bind(null, by.id('mySpan1')),
        cdeLabel: element.bind(null, by.id('mySpan2')),
        input: element.bind(null, by.id('myInput1'))
    };
